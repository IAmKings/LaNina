...
/**
 * Target identity for a manual daily-brief publication. The Worker resolves these from the cutoff;
 * a browser never chooses which public content gets frozen.
 */
 ...
 * and the freeze key that acts as the concurrency token for a retry.
 */
